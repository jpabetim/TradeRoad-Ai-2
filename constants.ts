...
`;
// Note: Changed {VOLUME_VALUE} to be consistent with JSON_OUTPUT_STRUCTURE_PROMPT replacement
// It was {{VOLUME_VALUE}} before, but json structure uses {VOLUME_VALUE}
...
`;
  ...
  context = context.replace("Información de RSI no disponible.", ""); // Clean up if present
...
export const mapTimeframeToApi = (timeframe: string): string => {
  // Ensures format like "1m", "1h", "4h", "1d", "1w"
